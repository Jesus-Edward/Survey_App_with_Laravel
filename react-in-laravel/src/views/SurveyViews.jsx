...
import { getResponseError } from "../errorUtilis";
...
export default function SurveyViews() {
    ...
    const onSubmit = (ev) => {
        ...
        res
            ...
            .catch(error => {
                ...
                const {title, expiry_date} = getResponseError(error);
                setErrors(title)
    ...
    function onQuestionsUpdate(questions) {
     ...
     const deletePublicSurvey = () => {
        console.log('Deleting public survey');
    ...
    return (
            <PageComponent
                ...
                button={
                    <div className="flex gap-2">
                        <TButton color="indigo" href={`/surveys/public/${survey.slug}`}>
                            <LinkIcon className="h-4 w-4 mr-2" />
                            Public Link

                        </TButton>

                        <TButton color="red" onClick={deletePublicSurvey}>
            ...
            >
                {loading && (<div className="text-center font-semibold text-lg">Loading...</div>)}
            {!loading && (<form method="POST" action="#" onSubmit={onSubmit}>
                        ...
                        <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                ...
                                <input
                                    ...
                                    className={
                                        errors
                                            ? "mt-1 block w-full rounded-md border-red-500 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
